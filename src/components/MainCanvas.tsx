  ...
  return (
    <main className="flex h-full min-w-0 flex-1 flex-col bg-[var(--background)]">
      ...
      <section className="flex min-h-0 flex-1 flex-col px-4 py-4 sm:px-6">
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--surface)] shadow-[var(--shadow-panel)]">
          <ChatRoom roomId="war-room-alpha" />
        </div>
      </section>
    </main>
  );
