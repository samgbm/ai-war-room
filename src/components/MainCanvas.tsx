...
export function MainCanvas() {
  return (
    <main className="flex h-full min-w-0 flex-1 flex-col bg-[var(--background)]">
      <header className="relative z-50 flex shrink-0 items-center justify-between gap-3 border-b border-[var(--border)] bg-[color-mix(in_oklab,var(--surface)_92%,transparent)] px-4 py-3 backdrop-blur-md sm:px-6">
